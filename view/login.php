...
<body>
    ...
    <div class="form" >
        ...
        <form action="/hj/model/read_user.php" method="post" class="login" onsubmit="return login(event)">
            ...
            <h1>Inicia Sesión</h1>
            <input id="nombre2" type="text" placeholder="Nombre" name="user" onkeypress="return sololetras(event)"> 
        ...
        <form action="/hj/model/create_user.php" method="post" class="register" onsubmit="return signup(event)">
            ...
            <h1>Regístrate</h1>
            <input id="nombre1" type="text" placeholder="Nombre" name="user" onkeypress="return sololetras(event)">
